...
## Update
The dataset used in the paper can be found [here]([https://www.kaggle.com/datasets/hellob/ai2thor-clip](https://github.com/xiaobaishu0097/ECCV-VN?tab=readme-ov-file)) Since the link of RGB data has expired, we have uploaded a backup copy of the [RGB data](https://www.kaggle.com/datasets/hellob/ai2thor-clip). Please check it.
